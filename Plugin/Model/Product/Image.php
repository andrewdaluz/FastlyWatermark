...
namespace Andrewdaluz\Fastly\Plugin\Model\Product;
 ...
 * Class Image
 * 
 * @package Andrewdaluz\Fastly\Plugin\Model\Product
 */
class Image
{
    /**
     ...
     */
    public function afterGetUrl(\Fastly\Cdn\Model\Product\Image $subject, $result)
    {
